...
public class MemoryFeatureContext : IDisposable
{
    ...
    public MemoryFeatureContext()
    {
        ...
        Store = TestData.CreateMemoryStore(Factory, NullLogger<SqliteMemoryStore>.Instance, new SqliteMemorySourceStore(Factory), new StubChunker(), TimeProvider, TestData.CreateEmbeddingService(), null, null, null, null, null, null, null);
    }
