...
public sealed class SnippetFallbackTests
{
    ...
    [Fact]
    public void From_ShortValue_IsReturnedUnchanged()
    {
        SnippetFallback.From("short text", "hash").ShouldBe("short text");
    }
    ...
    [Fact]
    public void From_LongValue_IsDeterministicForTheSameEntry()
    {
        SnippetFallback.From(LongValue, "entry-0000").ShouldBe(SnippetFallback.From(LongValue, "entry-0000"));
    }
