...
{
    private static MemorySearchResult Hit(string hash, string path = "") =>
        new(hash, 0, 0, string.IsNullOrEmpty(path) ? hash : path, "snippet");
    ...
    public void Fuse_Weights2To1_FavoursTheKeywordRankedList()
    {
        ...
        var fused = ReciprocalRankFusion.Fuse(
            [(fts, 2), (vec, 1)], k: 30, minScore: 0, limit: 10);
    ...
    public void Fuse_Weights1To2_FavoursTheVectorRankedList()
    {
        ...
        var fused = ReciprocalRankFusion.Fuse(
            [(fts, 1), (vec, 2)], k: 30, minScore: 0, limit: 10);
    ...
    public void Fuse_NormalizesToMax_SoTheTopResultIsOne()
    {
        ...
        var fused = ReciprocalRankFusion.Fuse([(fts, 1)], k: 60, minScore: 0, limit: 10);
    ...
    public void Fuse_CutoffK_ChangesTheScoreGapBetweenRanks()
    {
        ...
        var k10 = ReciprocalRankFusion.Fuse([(fts, 1)], k: 10, minScore: 0, limit: 10);
        var k60 = ReciprocalRankFusion.Fuse([(fts, 1)], k: 60, minScore: 0, limit: 10);
    ...
    public void Fuse_AppliesMinScoreAfterNormalization()
    {
        ...
        var fused = ReciprocalRankFusion.Fuse([(list, 1)], k: 10, minScore: 0.9, limit: 10);
    ...
    public void Fuse_AppliesLimit()
    {
        ...
        var fused = ReciprocalRankFusion.Fuse([(list, 1)], k: 60, minScore: 0, limit: 2);
    ...
    public void Fuse_PrefersTheFirstListsPayload_ForASharedHash()
    {
        ...
        var fused = ReciprocalRankFusion.Fuse([(fts, 1), (vec, 1)], k: 60, minScore: 0, limit: 10);
