...
public sealed class SqliteConnectionFactoryEncryptionTests : IDisposable
{
    ...
    public async Task OpenBankAsync_WithPassphrase_CreatesEncryptedDatabase()
    {
        ...
        var headerStr = System.Text.Encoding.ASCII.GetString(header[..16]);
    ...
    private sealed class StubEncryptionKeyProvider : IEncryptionKeyProvider
    {
        private readonly string? _passphrase;
        public StubEncryptionKeyProvider(string? passphrase) => _passphrase = passphrase;
        public string? GetPassphrase() => _passphrase;
    }
}
