...
public sealed class BaselineQueryCatalogTests
{
    private const string ExpectedCatalog =
        "A1 A2 A3 A4 A5 A6 A7 B1 B2 B3 B4 B5 B6 C1 C2 C3 C4 C5 C6 D1 D2 D3 D4 E1 E2 E3 F1 F2 F3 G1 G2 G3 H1 H2 H3 S2";
    ...
    public void AllQueries_UniqueIds_MatchCommittedCatalog()
    {
        ...
        queries.Length.ShouldBe(36, "the committed baseline catalog has 36 queries");
    ...
    public void ExpectedSourceQueries_DifficultyMatchesMeasuredHybridRanks()
    {
        ...
        // Measured 2026-08-04 on main @ 6889ee8 (hybrid k=60, 1:1, minScore 0.0), exact-chunk rank:
        // A2/A5/C1/C2/C5 exact@1; A1/A3 exact@2-3; A4/A7/S2 exact@4-5; A6 exact outside top-5.
    ...
    public void ExpectedSourceQueries_HaveRelevanceGrade()
    {
        ...
        // question needs the whole ADR, not one chunk).
        var expected = new Dictionary<string, int>
        {
            ["A1"] = 5, ["A2"] = 5, ["A3"] = 5, ["A4"] = 5, ["A5"] = 5,
            ["A6"] = 4, ["A7"] = 4, ["S2"] = 5, ["C1"] = 5, ["C2"] = 5, ["C5"] = 5,
        };
