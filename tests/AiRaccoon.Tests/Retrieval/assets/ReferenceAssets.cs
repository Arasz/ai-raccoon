...
public sealed class ReferenceAssets
{
    ...
    private static string TargetPath(PinnedAsset asset) => asset.Name switch
    {
    ...
    private static string? ExpandHome(string? path) =>
        path is null ? null : Path.GetFullPath(path.Replace("~", Environment.GetFolderPath(Environment.SpecialFolder.UserProfile)));
