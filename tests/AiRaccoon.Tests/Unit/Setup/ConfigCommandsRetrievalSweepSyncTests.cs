...
public class ConfigCommandsRetrievalSweepSyncTests
{
        ...
        TextReader? stdin = null)
    {
        ...
        var exit = await new ConfigCommands(settings: new SettingsCommands(), sync: new SyncCommands()).RunAsync(parsed.CommandPath, parsed.ParsedCliArgs, store, stdout, stderr,
            stdin ?? TextReader.Null, ctx: TestContext.Current.CancellationToken);
