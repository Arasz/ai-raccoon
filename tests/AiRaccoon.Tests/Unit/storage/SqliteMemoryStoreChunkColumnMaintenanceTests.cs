...
public sealed class SqliteMemoryStoreChunkColumnMaintenanceTests : IAsyncLifetime
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _store = new SqliteMemoryStore(_factory, NullLogger<SqliteMemoryStore>.Instance, new SqliteMemorySourceStore(_factory), new ParagraphChunker(), new FakeTimeProvider(FixedNow),
