...
public sealed class MemorySqlContextKeyTests
{
    ...
    public void ContextKeyFor_EncodesEachContextShape(string context, string projectId, string expected) =>
        MemorySql.ContextKeyFor(context, projectId).ShouldBe(expected);
}
