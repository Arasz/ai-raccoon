...
| [`native-memory/`](native-memory/) | Implemented (merged to main 2026-08-04)  | [spec.json](native-memory/spec.json) — native .NET memory store replacing the pinned sqlite-memory extension |
