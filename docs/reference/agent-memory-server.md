...
| `watching-disabled` | Watching is disabled for the project | `watching-disabled: Watching is disabled for project '<project>'. Run 'ai-raccoon settings watch enable <projectId|*>' to enable it.` |
