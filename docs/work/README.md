...
| [2026-08-26-followups-research.md](2026-08-26-followups-research.md) | Research record (task `doctor-feature-match-cont`): the reset-guard seam (endpoint vs store), the checklist diff (R3 block 3 vs the 7-row draft), the derive-gate precedents. |
| [2026-08-26-followups-plan.md](2026-08-26-followups-plan.md) | Integrated implementation plan: rulings A1-A3 (endpoint guard, frozen message, exit 25), Ruling B (12-row checklist, blank-provider rewording), Ruling C (derive gate). |
| [2026-08-26-followups-R1-arch-review.md](2026-08-26-followups-R1-arch-review.md) | Independent architecture/correctness review: two MUSTs (phrase-pair table for rows 1/2; settings exit table row 25) plus SHOULDs/NICEs folded into the brief. |
| [2026-08-26-followups-R2-qa-review.md](2026-08-26-followups-R2-qa-review.md) | Independent QA/test-honesty review: both RED witnesses verified real, corrected test set (6 tests, theories over both verbs), every gate command run first-hand. |
| [2026-08-26-followups-brief.md](2026-08-26-followups-brief.md) | Binding implementation brief: WP1-WP4 with the frozen message, exit 25, the 12-row checklist, the derive gates, the 1.36.1 release path. Supersedes the plan where they differ. |
