...
Date: 2026-09-10. Corpus: project-corpus-100.json (topicDerivation=markup-aware-v1) (evaluated 99 of 100).
...
| C002 | ai-badger/custom | 0dcc1fc63d2d | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C009 | ai-badger/project | aa6b11b8cc74 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C010 | ai-badger/project | 0cb4d4ddf5be | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C011 | ai-badger/project | 407ab320871a | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C016 | ai-raccoon/project | 85c101758538 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C017 | ai-raccoon/project | 00c8f78b4b1f | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C020 | ai-raccoon/project | 55b9d1ac0fbd | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C023 | ai-raccoon/project | 7919c74edd68 | 0 0.000 | 0 0.000 | yes | none | 1/0 |  |
| C024 | ai-raccoon/project | 231996d09049 | 1 0.222 | 0 0.000 | NO | none | 1/0 |  |
| C025 | ai-raccoon/project | 1ff737b19a7f | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C026 | ai-raccoon/project | 011efa03c3e3 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C029 | ai-raccoon/project | 0e0f09f763c9 | 1 0.222 | 0 0.000 | NO | none | 1/0 |  |
...
| C036 | arasz-home-page/project | 044bb60f7ee9 | 1 0.222 | 0 0.000 | NO | none | 1/0 |  |
| C037 | arasz-home-page/project | 206f391939d8 | 1 0.222 | 0 0.000 | NO | none | 1/0 |  |
| C038 | arasz-home-page/project | 0497aef36697 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C039 | arasz-home-page/project | 2c957dc9c2f6 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C040 | arasz-home-page/project | d420480a49c2 | 0 0.000 | 1 0.222 | NO | fusion | 1/0 |  |
| C041 | arasz-home-page/project | abb36b6292f3 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C042 | arasz-home-page/project | 0de8251cc91a | 0 0.000 | 1 0.222 | NO | fusion | 1/0 |  |
...
| C056 | deepseek-harness/project | 22d662ca66ae | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C059 | deepseek-harness/project | 0e87dc0d3116 | 0 0.000 | 1 0.222 | NO | fusion | 1/0 |  |
| C060 | deepseek-harness/project | 13f25c20e279 | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C063 | hermes-default/project | 63345f6d0836 | 0 0.000 | 1 0.222 | NO | fusion | 1/0 |  |
...
| C068 | hermes-default/project | 7e8d4cbc9c2c | 0 0.000 | 1 0.222 | NO | fusion | 1/0 |  |
...
| C091 | jsaa/project | 9f69eda07b9d | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
...
| C094 | pi-badger-integration/project | 3381b30488a6 | 1 0.222 | 1 0.222 | yes | none | 1/1 |  |
| C095 | vue-kanban/project | 09d99638900d | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C096 | vue-kanban/project | 14bdd05072eb | 1 0.222 | 1 0.222 | yes | none | 1/0 |  |
| C097 | vue-kanban/project | 01403e0d71a0 | 0 0.000 | 0 0.000 | yes | none | 1/0 |  |
| C098 | vue-kanban/project | 077a5790544b | 1 0.222 | 1 0.222 | yes | none | 1/1 |  |
| C099 | vue-kanban/project | 8521a5f3877e | 1 0.222 | 1 0.222 | yes | none | 1/1 |  |
| C100 | vue-kanban/project | 000c8046f2db | 1 0.222 | 1 0.222 | yes | none | 1/1 |  |

## Aggregates

Queries: n=99, paired (both legs clean)=99.
Harness: hit-rate=0.828 (n=99), mean F1=0.192.
ai-raccoon: hit-rate=0.879 (n=99), mean F1=0.203.
Agreement table: both-hit a=76, harness-only b=6, ai-raccoon-only c=11, neither d=6 (cells sum to 99).
Agreement MCC: 0.3233.
...
| label | n | reading |
|---|---|---|
| none | 88 | no harness deficit under test (harness hit, or the bank missed too — agreement is never a deficit) |
| fusion | 11 | a leg's candidate window held the anchor; the fused pipeline did not serve it (dedupe/RRF/floor/Take(8)) |
...
| c_cell (bank-hit/harness-miss of 99 paired) | 11 | deficit labels sum; unknown share 0.0% (cap 5%) |
