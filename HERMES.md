...
Playwright drives a browser through accessibility snapshots: `browser_navigate`, then
`browser_snapshot` for element refs, then act on those refs. Each tool's own description covers the rest.
