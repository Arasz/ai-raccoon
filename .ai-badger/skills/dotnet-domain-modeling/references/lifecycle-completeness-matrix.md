...
When testing state machine transitions, build a **transition matrix** to ensure every invalid path is covered. For N states with M transition methods, you need
