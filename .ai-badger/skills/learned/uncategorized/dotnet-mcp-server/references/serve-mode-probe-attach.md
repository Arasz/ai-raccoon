# Serve-mode probe-attach + watchdog DI (verified 2026-08-06, ai-raccoon serve feature)
...
To detect "an ai-raccoon server is already listening on this port" (idempotent
