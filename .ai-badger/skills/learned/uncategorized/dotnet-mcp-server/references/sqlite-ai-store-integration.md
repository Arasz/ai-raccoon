...
against the REAL binaries. The spec-side research (function catalog, vectors.space API,
MCP SDK packages) lives in the design-specification skill's
`references/sqlite-ai-memory-stack-notes.md`; this file is the store-layer counterpart.
