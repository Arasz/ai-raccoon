...
Proven on AiRaccoon 19/19 parity (`tests/AiRaccoon.Tests/E2E/McpServerToolSurfaceE2ETests.cs`,
...
16/19 — it poisons every future CI run. (AiRaccoon watch trio was stable; the flaky
