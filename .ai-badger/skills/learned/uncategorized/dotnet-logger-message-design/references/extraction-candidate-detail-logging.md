# ai-raccoon S4 — propose-mode candidate-detail logging (plan digest, 2026-08-06)
...
## RED tests (tests/AiRaccoon.Tests/Unit/Extraction/ExtractionHostedServiceTests.cs)
