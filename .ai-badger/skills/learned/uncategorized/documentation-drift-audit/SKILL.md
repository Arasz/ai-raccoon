...
accumulated drift. Verified 2026-08-06 on ai-raccoon's root README (561 → 158
...
4. **Fix the class, not the site.** The same broken construct usually lives in
   ...
   packaged `src/AiRaccoon/README.md`. Grep the whole doc surface for the
...
observed practice. They often disagree: ai-raccoon's ADR README declares
...
Worked example (ai-raccoon, 2026-08-06): ADR-0002 drifted in 4 places — tool
...
- `references/readme-compaction-recipe.md` — worked example of the README
  compaction (ai-raccoon, 2026-08-06, 561 → 158 lines): ground-truth extraction
...
- `references/ai-badger-mcp-scaffold-declaration.md` — why a declared MCP server can
  ...
  (`hermes mcp add`; adjust is proposal-only), the ai-raccoon port-5000 single-instance
