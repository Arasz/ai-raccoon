...
metadata:
  hermes:
    tags: [python, pipx, uv, pep668, homebrew, macos]
    related_skills: [evidence-first-research, hermes-agent]
category: devops
---
...
## Reference Materials
- `references/pep668-macos-benchmarks.md` — Measured case study comparing `uv tool install`, `pipx`, and custom venvs installing `semantica` v0.6.5 under Homebrew Python 3.14.
