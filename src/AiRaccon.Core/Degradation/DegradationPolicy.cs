...
public static class DegradationPolicy
{
    public static bool ShouldDegrade(double rating, double ageDays, double threshold, double ttlDays)
        => rating < threshold && ageDays > ttlDays;

    public static bool ShouldDegrade(double rating, double ageDays, double threshold, double ttlDays, double? ttlOverrideDays)
        => rating < threshold && ageDays > (ttlOverrideDays ?? ttlDays);
}
