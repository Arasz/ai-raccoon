...
public sealed class MemoryPrompts
{
    ...
    [Description("How to use the ai-raccon memory server: project ids, workspace isolation, promotion to shared, and search scopes.")]
    public string MemoryUsageGuide(
        [Description("Optional project id to tailor the guide to.")] string? projectId = null)
    {
    ...
    public string WorkspaceConsolidationGuide(
        [Description("Optional workspace id being finished.")] string? workspaceId = null,
