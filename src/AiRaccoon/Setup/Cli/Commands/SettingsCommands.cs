...
public sealed class SettingsCommands
{
    ...
    public async Task<int> AccessDefaultShowAsync(IMemoryStore store, TextWriter stdout,
    ...
    public async Task<int> AccessListAsync(IMemoryStore store, TextWriter stdout,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<int> ModelResetAsync(IMemoryStore store, TextWriter stdout,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<int> ModelShowAsync(IMemoryStore store, TextWriter stdout,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<int> RetrievalAlphaShowAsync(IMemoryStore store, TextWriter stdout,
        CancellationToken cancellationToken)
    {
