...
public sealed class MemoryPrompts
{
        ...
        string? projectId = null)
    {
        ...
        return $"""
                ...
                - Shared tier empty or unsure what to promote? Run memory_share_extract (project_id(s), propose) to see ranked candidates with reasons; review, then promote the keepers explicitly (mode=promote).
