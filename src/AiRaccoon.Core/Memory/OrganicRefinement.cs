...
/// <summary>
///     Refines the channel prior for organic-note candidates: without it the model cannot tell a
...
///     Only called for the organic-note channel; routing lives in ProvenanceArchetypeClassifier.
/// </summary>
