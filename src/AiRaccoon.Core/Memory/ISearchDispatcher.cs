...
///     scope=shared) and its FTS5-only-mode warning, and the search_quality recording rule for
///     every kind (ADR-0094) — so the MCP tool layer stays a thin caller (mcp.instructions.md).
/// </summary>
