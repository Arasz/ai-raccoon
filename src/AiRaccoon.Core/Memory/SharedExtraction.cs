...
/// <summary>
///     A ranked candidate with the mechanical reasons it scored. Only Score and Reasons fed
///     the ranking — Rating/AccessCount are informational context v3 does not read (ADR-0018).
/// </summary>
public sealed record ShareCandidate(
    ...
    string ValuePreview,
    double Score,
    [property: Description("Informational only — not a scoring input.")]
    double Rating,
    [property: Description("How many search result sets this hash appeared in — not a usage count, and not a scoring input.")]
    int AccessCount,
    DateTimeOffset CreatedAt,
...
/// <summary>
///     Extraction outcome: ranked candidates; in promote mode the hashes actually created
///     (promoted), chunks folded into already-represented files (absorbed), and value twins skipped.
/// </summary>
